...
/**
 * Enables data providers to check if other data files currently exist. The instance provided in the
 * {@link GatherDataEvent} utilizes the standard resources (via {@link VanillaPackResources}), forge's resources, as
 * well as any extra resource packs passed in via the {@code --existing} argument, or mod resources via the
 * {@code --existing-mod} argument.
 */
public class ExistingFileHelper {
    ...
    /**
     * Create a new helper. This should probably <em>NOT</em> be used by mods, as the instance provided by forge is
     * designed to be a central instance that tracks existence of generated data.
     * <p>
    ...
    public ExistingFileHelper(Collection<Path> existingPacks, Set<String> existingMods, boolean enable,
        ...
        if (assetIndex != null && assetsDir != null) {
            candidateClientResources.add(
                    new DefaultClientPackResources(ClientPackSource.BUILT_IN, new AssetIndex(assetsDir, assetIndex)));
        }
     ...
     *
     * @param loc      the complete location of the resource, e.g. {@code "minecraft:textures/block/stone.png"}
    ...
    /**
     * Check if a given resource exists in the known resource packs. This is a convenience method to avoid repeating
     * type/prefix/suffix and instead use the common definitions in {@link ResourceType}, or a custom
     * {@link IResourceType} definition.
     * 
     * @param loc  the base location of the resource, e.g. {@code "minecraft:block/stone"}
     * @param type a {@link IResourceType} describing how to form the path to the resource
     * @return {@code true} if the resource exists in any pack, {@code false} otherwise
     */
    ...
    /**
     * Track the existence of a generated file. This is a convenience method to avoid repeating type/prefix/suffix and

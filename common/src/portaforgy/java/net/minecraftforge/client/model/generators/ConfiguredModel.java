 ...
 * <p>
 * Can be manually constructed, created by static factory such as {@link #allYRotations(ModelFile, int, boolean)}, or
 * created by builder via {@link #builder()}.
 */
public final class ConfiguredModel {
     ...
     * @throws IllegalArgumentException if x and/or y rotation are not valid (see {@link ModelRotation})
    ...
    /**
     * Construct a new {@link ConfiguredModel} with the {@link #DEFAULT_WEIGHT default random weight}.
     * 
     * @param model     the underlying model
     * @param rotationX x-rotation to apply to the model
     * @param rotationY y-rotation to apply to the model
    ...
    /**
     * Construct a new {@link ConfiguredModel} with the default rotation (0, 0), uvlock (false), and
     * {@link #DEFAULT_WEIGHT default random weight}.
     * 
     * @throws NullPointerException if {@code model} is {@code null}
     */
    ...
    /**
     * A builder for {@link ConfiguredModel}s, which can contain a callback for processing the finished result. If no
     * callback is available (e.g. in the case of {@link ConfiguredModel#builder()}), some methods will not be
     * available.
     * <p>
     * Multiple models can be configured at once through the use of {@link #nextModel()}.
     *
     * @param <T> the type of the owning builder, which supplied the callback, and will be returned upon completion.
     */
    public static class Builder<T> {
         ...
         * @return this builder
         * @throws IllegalArgumentException if {@code value} is not a valid x-rotation (see {@link ModelRotation})
         */
         ...
         * @return this builder
         * @throws IllegalArgumentException if {@code value} is not a valid y-rotation (see {@link ModelRotation})
         */
        ...
        /**
         * Build the most recent model, as if {@link #nextModel()} was never called. Useful for single-model builders.
         * 
        ...
        /**
         * Apply the contained callback and return the owning builder object. What the callback does is not defined by
         * this class, but most likely it adds the built models to the current variant being configured.
         * <p>
        ...
        /**
         * Complete the current model and return a new builder instance with the same callback, and storing all

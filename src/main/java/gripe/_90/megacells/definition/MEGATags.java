...
public final class MEGATags {
    ...
    public static final TagKey<Item> SKY_BRONZE_INGOT =
            TagKey.create(Registries.ITEM, ResourceLocation.parse("forge:ingots/sky_bronze"));

    public static final TagKey<Block> SKY_STEEL_BLOCK =
            TagKey.create(Registries.BLOCK, ResourceLocation.parse("forge:storage_blocks/sky_steel"));
    public static final TagKey<Block> SKY_BRONZE_BLOCK =
            TagKey.create(Registries.BLOCK, ResourceLocation.parse("forge:storage_blocks/sky_bronze"));

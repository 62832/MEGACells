...
public class MEGARecipeProvider extends RecipeProvider.Runner {
        ...
        protected void buildRecipes() {
            ...
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.SKY_STEEL_INGOT, 9)
                    ...
                    .save(
                            ...
                            ResourceKey.create(
                                    Registries.RECIPE,
                                    MEGACells.makeId("crafting/sky_steel_ingot_from_sky_steel_block")));
            ...
            ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.BULK_CELL_COMPONENT)
                    ...
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/bulk_cell_component")));
            ...
            ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.BULK_ITEM_CELL)
                    ...
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("cells/standard/bulk_item_cell")));
            ...
            ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGABlocks.MEGA_CRAFTING_UNIT)
                    ...
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/mega_crafting_unit")));
            ...
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.GREATER_ENERGY_CARD)
                    ...
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/greater_energy_card")));
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.GREATER_ENERGY_CARD)
            ...
            ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.DECOMPRESSION_MODULE)
                    ...
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/decompression_module")));
            ...
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_PATTERN_PROVIDER)
                    ...
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_pattern_provider")));
            ...
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.MEGA_INTERFACE)
                    ...
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_interface_part")));
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_INTERFACE)
                    .requires(MEGAItems.MEGA_INTERFACE)
                    .unlockedBy("has_cable_mega_interface", has(MEGAItems.MEGA_INTERFACE))
                    .save(
                            output,
                            ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_interface_block")));
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.MEGA_PATTERN_PROVIDER)
                    ...
                    .save(
                            output,
                            ResourceKey.create(
                                    Registries.RECIPE, MEGACells.makeId("network/mega_pattern_provider_part")));
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_PATTERN_PROVIDER)
                    ...
                    .save(
                            output,
                            ResourceKey.create(
                                    Registries.RECIPE, MEGACells.makeId("network/mega_pattern_provider_block")));
            ...
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_EMC_INTERFACE)
                    ...
                    .save(
                            output,
                            ResourceKey.create(
                                    Registries.RECIPE, MEGACells.makeId("network/mega_emc_interface_block")));
            ...
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, cell)
                    ...
                    .save(
                            ...
                            ResourceKey.create(
                                    Registries.RECIPE,
                                    MEGACells.makeId(
                                            "cells/standard/" + cell.id().getPath() + "_with_housing")));
            output.accept(
                    ResourceKey.create(
                            Registries.RECIPE,
            ...
            ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, cell)
                    ...
                    .save(
                            ...
                            ResourceKey.create(
                                    Registries.RECIPE,
                                    MEGACells.makeId(
                                            "cells/standard/" + cell.id().getPath())));
            ...
            ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, cell)
                    ...
                    .save(
                            ...
                            ResourceKey.create(
                                    Registries.RECIPE,
                                    MEGACells.makeId(
                                            "cells/portable/" + cell.id().getPath())));
            output.accept(
                    ResourceKey.create(
                            Registries.RECIPE,

...
public class MEGARecipeProvider extends RecipeProvider {
    public MEGARecipeProvider(HolderLookup.Provider registries, RecipeOutput output) {
    ...
    protected void buildRecipes() {
        ...
        component(output, MEGAItems.TIER_4M, MEGAItems.TIER_1M, Ingredient.of(items.getOrThrow(ConventionTags.ENDER_PEARL_DUST)));
        component(output, MEGAItems.TIER_16M, MEGAItems.TIER_4M, Ingredient.of(items.getOrThrow(ConventionTags.ENDER_PEARL_DUST)));
        ...
        housing(output, MEGAItems.MEGA_ITEM_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_STEEL_INGOT)));
        housing(output, MEGAItems.MEGA_FLUID_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_BRONZE_INGOT)));
        housing(conditional(output, Addons.APPMEK), MEGAItems.MEGA_CHEMICAL_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_OSMIUM_INGOT)));
        housing(conditional(output, Addons.APPEX), MEGAItems.MEGA_EXPERIENCE_CELL_HOUSING, Ingredient.of(Items.EXPERIENCE_BOTTLE));

        cell(output, MEGAItems.ITEM_CELL_1M, MEGAItems.CELL_COMPONENT_1M, MEGAItems.MEGA_ITEM_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_STEEL_INGOT)));
        cell(output, MEGAItems.ITEM_CELL_4M, MEGAItems.CELL_COMPONENT_4M, MEGAItems.MEGA_ITEM_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_STEEL_INGOT)));
        cell(output, MEGAItems.ITEM_CELL_16M, MEGAItems.CELL_COMPONENT_16M, MEGAItems.MEGA_ITEM_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_STEEL_INGOT)));
        cell(output, MEGAItems.ITEM_CELL_64M, MEGAItems.CELL_COMPONENT_64M, MEGAItems.MEGA_ITEM_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_STEEL_INGOT)));
        cell(output, MEGAItems.ITEM_CELL_256M, MEGAItems.CELL_COMPONENT_256M, MEGAItems.MEGA_ITEM_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_STEEL_INGOT)));

        cell(output, MEGAItems.FLUID_CELL_1M, MEGAItems.CELL_COMPONENT_1M, MEGAItems.MEGA_FLUID_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_BRONZE_INGOT)));
        cell(output, MEGAItems.FLUID_CELL_4M, MEGAItems.CELL_COMPONENT_4M, MEGAItems.MEGA_FLUID_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_BRONZE_INGOT)));
        cell(output, MEGAItems.FLUID_CELL_16M, MEGAItems.CELL_COMPONENT_16M, MEGAItems.MEGA_FLUID_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_BRONZE_INGOT)));
        cell(output, MEGAItems.FLUID_CELL_64M, MEGAItems.CELL_COMPONENT_64M, MEGAItems.MEGA_FLUID_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_BRONZE_INGOT)));
        cell(output, MEGAItems.FLUID_CELL_256M, MEGAItems.CELL_COMPONENT_256M, MEGAItems.MEGA_FLUID_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_BRONZE_INGOT)));

        cell(conditional(output, Addons.APPMEK), MEGAItems.CHEMICAL_CELL_1M, MEGAItems.CELL_COMPONENT_1M, MEGAItems.MEGA_CHEMICAL_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_OSMIUM_INGOT)));
        cell(conditional(output, Addons.APPMEK), MEGAItems.CHEMICAL_CELL_4M, MEGAItems.CELL_COMPONENT_4M, MEGAItems.MEGA_CHEMICAL_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_OSMIUM_INGOT)));
        cell(conditional(output, Addons.APPMEK), MEGAItems.CHEMICAL_CELL_16M, MEGAItems.CELL_COMPONENT_16M, MEGAItems.MEGA_CHEMICAL_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_OSMIUM_INGOT)));
        cell(conditional(output, Addons.APPMEK), MEGAItems.CHEMICAL_CELL_64M, MEGAItems.CELL_COMPONENT_64M, MEGAItems.MEGA_CHEMICAL_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_OSMIUM_INGOT)));
        cell(conditional(output, Addons.APPMEK), MEGAItems.CHEMICAL_CELL_256M, MEGAItems.CELL_COMPONENT_256M, MEGAItems.MEGA_CHEMICAL_CELL_HOUSING, Ingredient.of(items.getOrThrow(MEGATags.SKY_OSMIUM_INGOT)));
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, MEGABlocks.SKY_STEEL_BLOCK)
                .pattern("###")
                .pattern("###")
                .pattern("###")
                .define('#', MEGATags.SKY_STEEL_INGOT)
                .unlockedBy("has_sky_steel_ingot", has(MEGATags.SKY_STEEL_INGOT))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/sky_steel_block")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.SKY_STEEL_INGOT, 9)
                .requires(MEGABlocks.SKY_STEEL_BLOCK)
                .unlockedBy("has_sky_steel_ingot", has(MEGATags.SKY_STEEL_INGOT))
                .save(
                        output,
                        ResourceKey.create(
                                Registries.RECIPE, MEGACells.makeId("crafting/sky_steel_ingot_from_sky_steel_block")));

        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, MEGABlocks.SKY_BRONZE_BLOCK)
                .pattern("###")
                .pattern("###")
                .pattern("###")
                .define('#', MEGATags.SKY_BRONZE_INGOT)
                .unlockedBy("has_sky_bronze_ingot", has(MEGATags.SKY_BRONZE_INGOT))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/sky_bronze_block")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.SKY_BRONZE_INGOT, 9)
                ...
                .save(
                        ...
                        ResourceKey.create(
                                Registries.RECIPE,
                                MEGACells.makeId("crafting/sky_bronze_ingot_from_sky_bronze_block")));

        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, MEGABlocks.SKY_OSMIUM_BLOCK)
                .pattern("###")
                .pattern("###")
                .pattern("###")
                .define('#', MEGATags.SKY_OSMIUM_INGOT)
                .unlockedBy("has_sky_osmium_ingot", has(MEGATags.SKY_OSMIUM_INGOT))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/sky_osmium_block")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.SKY_OSMIUM_INGOT, 9)
                ...
                .save(
                        ...
                        ResourceKey.create(
                                Registries.RECIPE,
                                MEGACells.makeId("crafting/sky_osmium_ingot_from_sky_osmium_block")));
        ...
        TransformRecipeBuilder.transform(
                ...
                Ingredient.of(items.getOrThrow(ConventionTags.IRON_INGOT)),
        ...
        TransformRecipeBuilder.transform(
                ...
                TransformCircumstance.fluid(FluidTags.LAVA),
                Ingredient.of(AEItems.CERTUS_QUARTZ_CRYSTAL_CHARGED),
                Ingredient.of(items.getOrThrow(ConventionTags.COPPER_INGOT)),
                Ingredient.of(AEBlocks.SKY_STONE_BLOCK));
        TransformRecipeBuilder.transform(
                output,
                ...
                TransformCircumstance.fluid(FluidTags.LAVA),
                Ingredient.of(AEItems.CERTUS_QUARTZ_CRYSTAL_CHARGED),
                Ingredient.of(items.getOrThrow(ItemTags.create(Identifier.parse("c:ingots/osmium")))),
                Ingredient.of(AEBlocks.SKY_STONE_BLOCK));
        ...
        InscriberRecipeBuilder.inscribe(
                        items.getOrThrow(MEGATags.SKY_STEEL_INGOT), MEGAItems.ACCUMULATION_PROCESSOR_PRINT, 1)
                .setTop(Ingredient.of(MEGAItems.ACCUMULATION_PROCESSOR_PRESS))
                .setMode(InscriberProcessType.INSCRIBE)
                .save(output, MEGACells.makeId("inscriber/accumulation_processor_print"));
        InscriberRecipeBuilder.inscribe(
                        items.getOrThrow(ConventionTags.FLUIX_DUST), MEGAItems.ACCUMULATION_PROCESSOR, 1)
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.BULK_CELL_COMPONENT)
                .pattern("aba")
                .pattern("cdc")
                .pattern("aea")
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/bulk_cell_component")));

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.BULK_ITEM_CELL)
                .pattern("aba")
                .pattern("bcb")
                .pattern("ddd")
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("cells/standard/bulk_item_cell")));

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGABlocks.MEGA_ENERGY_CELL)
                .pattern("aaa")
                .pattern("aba")
                .pattern("aaa")
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/mega_energy_cell")));

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGABlocks.MEGA_CRAFTING_UNIT)
                .pattern("aba")
                .pattern("cdc")
                .pattern("aba")
                ...
                .unlockedBy("has_accumulation_processor", has(MEGAItems.ACCUMULATION_PROCESSOR))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/mega_crafting_unit")));
        ...
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.GREATER_ENERGY_CARD)
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/greater_energy_card")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.GREATER_ENERGY_CARD)
                ...
                .save(
                        output,
                        ResourceKey.create(
                                Registries.RECIPE, MEGACells.makeId("crafting/greater_energy_card_upgraded")));

        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.COMPRESSION_CARD)
                .requires(AEItems.ADVANCED_CARD)
                .requires(AEItems.MATTER_BALL)
                .unlockedBy("has_advanced_card", has(AEItems.ADVANCED_CARD))
                .unlockedBy("has_matter_ball", has(AEItems.MATTER_BALL))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/compression_card")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.DECOMPRESSION_MODULE)
                .pattern("IAI")
                .pattern("C#E")
                .pattern("ILI")
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("crafting/decompression_module")));

        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_INTERFACE)
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_interface")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_PATTERN_PROVIDER)
                .requires(AEBlocks.PATTERN_PROVIDER)
                .requires(MEGAItems.ACCUMULATION_PROCESSOR)
                .unlockedBy("has_accumulation_processor", has(MEGAItems.ACCUMULATION_PROCESSOR))
                .unlockedBy("has_pattern_provider", has(ConventionTags.PATTERN_PROVIDER))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_pattern_provider")));

        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.MEGA_INTERFACE)
                .requires(MEGABlocks.MEGA_INTERFACE)
                .unlockedBy("has_mega_interface", has(MEGABlocks.MEGA_INTERFACE))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_interface_part")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_INTERFACE)
                .requires(MEGAItems.MEGA_INTERFACE)
                .unlockedBy("has_cable_mega_interface", has(MEGAItems.MEGA_INTERFACE))
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_interface_block")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.MEGA_PATTERN_PROVIDER)
                .requires(MEGABlocks.MEGA_PATTERN_PROVIDER)
                .unlockedBy("has_mega_pattern_provider", has(MEGABlocks.MEGA_PATTERN_PROVIDER))
                .save(
                        output,
                        ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_pattern_provider_part")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_PATTERN_PROVIDER)
                .requires(MEGAItems.MEGA_PATTERN_PROVIDER)
                .unlockedBy("has_cable_mega_pattern_provider", has(MEGAItems.MEGA_PATTERN_PROVIDER))
                .save(
                        output,
                        ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_pattern_provider_block")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGAItems.MEGA_EMC_INTERFACE)
                .requires(MEGABlocks.MEGA_EMC_INTERFACE)
                .unlockedBy("has_mega_emc_interface", has(MEGABlocks.MEGA_EMC_INTERFACE))
                .save(
                        output,
                        ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_emc_interface_part")));
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, MEGABlocks.MEGA_EMC_INTERFACE)
                ...
                .save(
                        output,
                        ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/mega_emc_interface_block")));

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.CELL_DOCK)
                .pattern("ICI")
                .pattern(" # ")
                .define('I', ConventionTags.IRON_INGOT)
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/cell_dock")));
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, MEGAItems.PORTABLE_CELL_WORKBENCH)
                .pattern("W")
                .pattern("S")
                .pattern("C")
                ...
                .save(
                        output,
                        ResourceKey.create(Registries.RECIPE, MEGACells.makeId("network/portable_cell_workbench")));
        ...
        // ArsEng, AppEx, Applied Soul and AppliedE don't have Minecraft 26.1 releases available at
        // runtime yet (see build.gradle.kts), so there's no datagen counterpart to call into here
        // right now.
    }

    private void component(RecipeOutput output, StorageTier tier, StorageTier preceding, Ingredient binder) {
        var precedingComponent = preceding.componentSupplier().get();
        ShapedRecipeBuilder.shaped(
                        items, RecipeCategory.MISC, tier.componentSupplier().get())
                .pattern("aba")
                .pattern("cdc")
                .pattern("aca")
                .define('a', binder)
    ...
    private void housing(RecipeOutput output, ItemDefinition<?> housing, Ingredient housingMaterial) {
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, housing)
                .pattern("aba")
                .pattern("b b")
                .pattern("ddd")
                .define('a', AEBlocks.QUARTZ_VIBRANT_GLASS)
                ...
                .save(
                        ...
                        ResourceKey.create(
                                Registries.RECIPE,
                                MEGACells.makeId("cells/" + housing.id().getPath())));
    }

    private void cell(
            RecipeOutput output, ItemDefinition<?> cell, ItemDefinition<?> component, ItemDefinition<?> housing) {
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, cell)
                .requires(housing)
                .requires(component)
        ...
        output.accept(
                ...
                new StorageCellDisassemblyRecipe(cell.asItem(), List.of(component.template(), housing.template())),
                null);
    }
    ...
    private void cell(
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, cell)
                .pattern("aba")
                .pattern("bcb")
                .pattern("ddd")
                .define('a', AEBlocks.QUARTZ_VIBRANT_GLASS)
        ...
        output.accept(
                ...
                new StorageCellDisassemblyRecipe(
                        ...
                        List.of(
                                component.template(),
                                housing.template(),
                                AEBlocks.ME_CHEST.item().template(),
                                AEBlocks.DENSE_ENERGY_CELL.item().template())),
                null);
    }

    private void craftingBlock(RecipeOutput output, BlockDefinition<?> unit, ItemLike part) {
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.MISC, unit)
                ...
                .save(
                        ...
                        ResourceKey.create(
                                Registries.RECIPE,
                                MEGACells.makeId("crafting/" + unit.id().getPath())));
        output.accept(
                ResourceKey.create(
                        Registries.RECIPE,

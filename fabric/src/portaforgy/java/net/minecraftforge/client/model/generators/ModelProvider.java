...
public abstract class ModelProvider<T extends ModelBuilder<T>> implements DataProvider {
    ...
    public ModelProvider(DataGenerator generator, String modid, String folder, Function<ResourceLocation, T> factory,
    ...
    public ModelProvider(DataGenerator generator, String modid, String folder,
    ...
    public T getBuilder(String path) {
        ...
        ResourceLocation outputLoc = extendWithFolder(
                path.contains(":") ? new ResourceLocation(path) : new ResourceLocation(modid, path));
    ...
    private Path getPath(T model) {
        ...
        return generator.getOutputFolder()
                .resolve("assets/" + loc.getNamespace() + "/models/" + loc.getPath() + ".json");
    }
}

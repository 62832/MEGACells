...
public final class AppMekItems {
    ...
    public static final ItemDefinition<MEGAPortableChemicalCell> PORTABLE_CHEMICAL_CELL_1M =
            portable(MEGAItems.TIER_1M);
    public static final ItemDefinition<MEGAPortableChemicalCell> PORTABLE_CHEMICAL_CELL_4M =
            portable(MEGAItems.TIER_4M);
    public static final ItemDefinition<MEGAPortableChemicalCell> PORTABLE_CHEMICAL_CELL_16M =
            portable(MEGAItems.TIER_16M);
    public static final ItemDefinition<MEGAPortableChemicalCell> PORTABLE_CHEMICAL_CELL_64M =
            portable(MEGAItems.TIER_64M);
    public static final ItemDefinition<MEGAPortableChemicalCell> PORTABLE_CHEMICAL_CELL_256M =
